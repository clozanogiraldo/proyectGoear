...
class CuarPage extends StatefulWidget {
  @override
  _CuarPageState createState() => _CuarPageState();
}

class _CuarPageState extends State<CuarPage> {
 @override
                        ...
                        FadeAnimation(1.4, Container(
                          ...
                          padding:  EdgeInsets.symmetric(horizontal: 0.0 ),
                                                  child: RaisedButton(
                                                    ...
                                                    child: Text("Oriental", style: TextStyle(color:  Colors.black87, fontSize: 18,fontWeight: FontWeight.bold)),
                                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)),
                                                  ),
                                                )),
            ...
            Expanded(
              child: Padding(
                ...
                child: ListView(
                  scrollDirection: Axis.horizontal,
                  children: <Widget>[
                    FadeAnimation(1.4, makeItem(image: 'assets/images/ori.jpg')),
                    FadeAnimation(1.5, makeItem(image: 'assets/images/ramen.jpg')),
                    FadeAnimation(1.6, makeItem(image: 'assets/images/sushi.jpg')),
                    FadeAnimation(1.7, makeItem(image: 'assets/images/ori2.jpg')),
                  ],
                ),
              ),
            ),
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 5,),
                      Text("\$ 25.000 a \$ 65.000", style: TextStyle(color: Colors.white, fontSize: 15,fontWeight: FontWeight.bold),),
                      SizedBox(height: 5,),
                      Text("Platos Orientales", style: TextStyle(color: Colors.white, fontSize: 20),),
                    ],
                  )
                ],
              ),
