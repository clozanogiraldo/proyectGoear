...
class SecoPage extends StatefulWidget {
  @override
  _SecoPageState createState() => _SecoPageState();
}

class _SecoPageState extends State<SecoPage> {
  @override
                        ...
                        FadeAnimation(1.3, Container(
                          ...
                          padding:  EdgeInsets.symmetric(horizontal: 0.0 ),
                                                  child: RaisedButton(
                                                    ...
                                                    child: Text("Italiana", style: TextStyle(color:  Colors.black87, fontSize: 18,fontWeight: FontWeight.bold)),
                                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)),
                                                  ),
                                                )),
            ...
            Expanded(
              child: Padding(
                ...
                child: ListView(
                  scrollDirection: Axis.horizontal,
                  children: <Widget>[
                    FadeAnimation(1.4, makeItem(image: 'assets/images/ital.jpg')),
                    FadeAnimation(1.5, makeItem(image: 'assets/images/lasa.jpg')),
                    FadeAnimation(1.6, makeItem(image: 'assets/images/ques.jpg')),
                    FadeAnimation(1.7, makeItem(image: 'assets/images/carneita.jpg')),
                  ],
                ),
              ),
            ),
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 5,),
                      Text("\$ 25.000 a \$ 45.000", style: TextStyle(color: Colors.white, fontSize: 15,fontWeight: FontWeight.bold),),
                      SizedBox(height: 5,),
                      Text("Platos Italianos", style: TextStyle(color: Colors.white, fontSize: 20),),
                    ],
                  )
                ],
              ),
