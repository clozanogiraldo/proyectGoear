                        ...
                        FadeAnimation(1.4, Container(
                          ...
                          padding:  EdgeInsets.symmetric(horizontal: 0.0 ),
                                                  child: RaisedButton(
                                                    ...
                                                    child: Text("Mexicana", style: TextStyle(color:  Colors.black87, fontSize: 18,fontWeight: FontWeight.bold)),
                                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)),
                                                  ),
                                                )),
                        FadeAnimation(1.4, Container(
            ...
            Expanded(
              child: Padding(
                ...
                child: ListView(
                  scrollDirection: Axis.horizontal,
                  children: <Widget>[
                    FadeAnimation(1.4, makeItem(image: 'assets/images/tacos.jpg')),
                    FadeAnimation(1.5, makeItem(image: 'assets/images/burros.jpg')),
                    FadeAnimation(1.6, makeItem(image: 'assets/images/comimex.jpg')),
                    FadeAnimation(1.7, makeItem(image: 'assets/images/dori.jpg')),
                  ],
                ),
              ),
            ),
                  ...
                  Column(
                    ...
                    children: <Widget>[
                     Text("Desde", style: TextStyle(color: Colors.white, fontSize: 15,fontWeight: FontWeight.bold),),
                      SizedBox(height: 5,),
                      Text("\$ 15.000 a \$ 45.000", style: TextStyle(color: Colors.white, fontSize: 15,fontWeight: FontWeight.bold),),
                      SizedBox(height: 5,),
                      Text("Platos Mexicanos", style: TextStyle(color: Colors.white, fontSize: 20),),
                    ],
                  )
                ],
              ),
